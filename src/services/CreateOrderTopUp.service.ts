...
export interface CreateOrderTopUpProps {
...
class CreateOrderTopUpService {
  CreateOrderTopUp(body: RequestCommon<CreateOrderTopUpProps>): Promise<Response> {
    return httpServices.post(`${ROOT_URL}`, body);
  }
}

export default new CreateOrderTopUpService();
